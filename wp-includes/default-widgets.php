...
<?php
            ...
            echo apply_filters( 'widget_meta_soulteary', sprintf( '<li><a href="%s" title="%s">%s</a></li>',
                esc_url( __( 'http://www.soulteary.com/' ) ),
                esc_attr__( 'WordPress For SAE 维护者，如果在使用的过程中遇到问题，欢迎至此反馈。' ),
                _x( '苏洋博客', 'meta widget link text' )
            ) );
			/**
